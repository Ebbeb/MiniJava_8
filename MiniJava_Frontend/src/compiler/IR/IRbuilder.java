...
//	typeClass   : className=IDENT;
	...
	public MJType visitTypeDouble(MiniJavaParser.TypeDoubleContext ctx) {
...
//	expressionMethodCall      :  (object=identifier '.')? method=IDENT '(' (arguments+=expression (',' arguments+=expression)* )? ')' ;
	...
	public MJExpression visitExpressionConstantDouble(MiniJavaParser.ExpressionConstantDoubleContext ctx) {
