...
public class MiniJavaParser extends Parser {
	...
	public static final int
		...
		IDENT=35, INT=36, STRING=37, LINE_COMMENT=38, MULTILINE_COMMENT=39, WHITESPACE=40, TYPEDOUBLE=41, DOUBLE=42;
	public static final String[] tokenNames = {
		...
		"LINE_COMMENT", "MULTILINE_COMMENT", "WHITESPACE", "double"
	};
	public static final int
		...
		RULE_idIDENT = 46, RULE_typeDouble = 47, RULE_expressionConstantDouble = 48;
	public static final String[] ruleNames = {
		...
		"idThis", "idIDENT", "expressionConstantDouble"
	};
	...
	public static class ExpressionConstantDoubleContext extends ParserRuleContext {
		public Token value;
		public TerminalNode INT() { return getToken(MiniJavaParser.DOUBLE, 0); }
	...
	public final ExpressionConstantDoubleContext expressionConstantDouble() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(356); ((ExpressionConstantDoubleContext)_localctx).value = match(INT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
